...
<head>
    ...
    <link href="/static/mark/css/bootstrap.css" rel="stylesheet">
    <link href="/static/markcss/fontawesome-all.css" rel="stylesheet">
	<link href="/static/markcss/styles.css" rel="stylesheet">
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark">
        <div class="container">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="/static/mark/index.html"><img src="images/logo.svg" alt="alternative"></a>  
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown01">
                            <a class="dropdown-item page-scroll" href="/static/mark/project.html">Project Details</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item page-scroll" href="/static/mark/terms.html">Terms Conditions</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item page-scroll" href="/static/mark/privacy.html">Privacy Policy</a>
                        </div>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="col-lg-12">     
                        ...
                        <div class="text-container">
                            ...
                            <div class="icons-container">
                                <img src='$lib/mark/images/details-icon-photoshop.png' alt="alternative">
                                <img src="/static/mark/images/details-icon-illustrator.png" alt="alternative">
                                <img src="/static/mark/images/details-icon-html.png" alt="alternative">
                                <img src="/static/mark/images/details-icon-css.png" alt="alternative">
                                <img src="/static/mark/images/details-icon-bootstrap.png" alt="alternative">
                                <img src="/static/mark/images/details-icon-javascript.png" alt="alternative">
